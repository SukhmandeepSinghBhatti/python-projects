...
while(True):
 ...
 print(" Choose from this list:- 1. 2 Ghore, 2. Akad, 3.Shoot Da Order, 4. We Rollin, 5. BANDOOK, 6. Tora, 7. Levels, 8. Be ready ")
 ...
 if "2 Ghore" in a:
     ...
     playsound("D:\\Coding\\python projects\\music player\songs\\Shoot Da Order.mp3")
      ...
      playsound("D:\\Coding\\python projects\\music player\songs\\Levels.mp3")  
 elif "Be ready" in a:
       playsound("D:\\Coding\\python projects\\music player\songs\\Be ready.mp3")  
 elif "Q" in a:
      exit()     
