...
def about():
  showinfo("Mr. Hacker","This program is a hacking tool.")
...
body_img = Label(aaa1,image=bck,bg='blue')
body_img.place(x=500,y=4)
body.place(x=12,y=300)
# gb.pack()

buttons = Button(aaa,text="Show",command=ss)
buttons.pack()
bg1.pack(side=BOTTOM,pady=1)
Button1 = Button(buttons,text="Show correct working dir",command=b1)
Button1.pack(pady=2)
